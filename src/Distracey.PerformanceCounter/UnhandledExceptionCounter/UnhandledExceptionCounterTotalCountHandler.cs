...
{
    public class UnhandledExceptionCounterTotalCountHandler : IUnhandledExceptionCounter
    {
        private readonly string _applicationName;
        private readonly string _instanceName;

        private const string TotalCountCounter = "UnhandledExceptionCounterTotalCountHandler";
        ...
        public UnhandledExceptionCounterTotalCountHandler(string applicationName, string instanceName)
        {
        ...
        {
            return "Unhandled Exception - Total number of operations";
        }
